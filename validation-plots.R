...
ggsave(filename="id-upset.png", plot=p1, dpi=300, width=8, height=4, units="in")
...
ggsave(filename="weekly-enforcement-events.png", plot=p2, dpi=300, width=8, height=6, units="in")
